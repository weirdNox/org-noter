...
** If you are new to *ORG-NOTER*
   Please first look at [[https://github.com/petermao/org-noter/blob/master/docs/README-orig.org][Gonçalo Santos's README]] ([[file:docs/README-orig.org]] in
   this repo).

** This is a refactor of the *c1-g* fork done collaborative by [[https://github.com/petermao/org-noter][*petermao*]] and [[https://github.com/dmitrym0/org-noter-plus-djvu][*dmitrym0*]]
   ...
   - djvu and epub support have also been advanced by *c1-g*, but we have not
     tested any of that code.  See [[https://github.com/petermao/org-noter/blob/master/docs/README-djvu.org][Charlie Gordon's README]]
